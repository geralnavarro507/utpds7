...
<?php
    ...
    if(array_key_exists('enviar',$_POST)){
        ...
        echo    '<form action="lab182.php" method = "POST">
                    <h2>Lab18.1 RegEx desde Back-end</h2>
                    Nombre <input type="text" name="nombre"><br>
                    Apellido <input type="text" name="apellido"><br>
                    Email <input type="email" name="email" pattern="/^([a-zA-Z0-9])+([a-zA-Z0-9\._-])*@([a-zA-Z0-9_-])+([a-zA-Z0-9\._-]+)+$/"><br>
...
?>
    <form action="lab182.php" method = "POST">
        <h2>Lab18.2 RegEx desde Back-end</h2>
        Nombre <input type="text" name="nombre"><br>
        Apellido <input type="text" name="apellido"><br>
        Email <input type="email" name="email" pattern="/^([a-zA-Z0-9])+([a-zA-Z0-9\._-])*@([a-zA-Z0-9_-])+([a-zA-Z0-9\._-]+)+$/"><br>
        Contraseña <input type="password" name="password" ><br>
