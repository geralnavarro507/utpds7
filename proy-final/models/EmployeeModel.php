...
class EmployeeModel {
    ...
    public function obtenerHorarios($usuarioId) {
        $apiUrl = API_URL . 'horarios.php?usuario='.$usuarioId;

        // Lógica para realizar la solicitud a la API y obtener los horarios
        // Puedes usar cURL o la función file_get_contents para hacer la solicitud HTTP
        ...
        // Decodificar la respuesta JSON (asumiendo que la API devuelve JSON)
        $horarios = json_decode($response, true);
