...
?>
    <div class="container bg-white mt-4" id="id_div1">
      <h2 id="id_titulointerno" class="text-center align-middle mt-2">DEPARTAMENTOS</h2>
      ...
      <form class="form-inline" role="form">
        ...
        <div class="input-group col pl-0 pr-0 mr-0 ml-0"> 
          ...
          <div class="col">
            <input  class="form-control col-12" type="text" id="id_descripcion" placeholder="Descripción...">
          </div>
        ...
        <tbody id="id_tbody1">
            <?php
                if ($_SERVER['REQUEST_METHOD'] === 'GET') {
                    ...
                    $depcontroller = new DepartamentoController();
                    echo $depcontroller->getDepartamento($codigo,$descripcion);
                }
            ?>
